...
if (isset($_SESSION['key'])) {
  if (@$_GET['fdid'] && $_SESSION['key'] == 'harsh') {
    $id = @$_GET['fdid'];
...
if (isset($_SESSION['key'])) 
{
  if (@$_GET['demail'] && $_SESSION['key'] == 'harsh') 
  {
    $demail = @$_GET['demail'];
...
//remove quiz
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'rmquiz' && $_SESSION['key'] == 'harsh') {
    $eid = @$_GET['eid'];
...
//add quiz
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'addquiz' && $_SESSION['key'] == 'harsh') {
    $name = $_POST['name'];
...
//add question
if (isset($_SESSION['key'])) {
  if (@$_GET['q'] == 'addqns' && $_SESSION['key'] == 'harsh') {
    $n = @$_GET['n'];
    $eid = @$_GET['eid'];
    $ch = @$_GET['ch'];
